...
import type { MailAccountConnectionItem } from '../types/mail-account-connections.types';

const mutateMock = vi.fn();
let listData: { items: MailAccountConnectionItem[] } | undefined;
let isLoading = false;
let isError = false;

vi.mock('../hooks/useConnectionList', () => ({
  useConnectionList: () => ({
    data: listData,
    isLoading,
    isError,
