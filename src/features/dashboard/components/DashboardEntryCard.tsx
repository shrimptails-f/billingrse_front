...
export const DashboardEntryCard = ({
  ...
  return (
    <section className="mx-auto max-w-5xl space-y-6 py-2">
      <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.08)] min-[960px]:p-8">
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-500 min-[960px]:text-base">
          ...
          {summary ? (
            <dl className="grid divide-y divide-slate-200 border-t border-slate-200 pt-6 min-[600px]:grid-cols-3 min-[600px]:divide-x min-[600px]:divide-y-0">
              {summaryItems.map((item) => (
                <div
                  key={item.key}
                  className="space-y-3 py-5 first:pt-0 last:pb-0 min-[600px]:px-5 min-[600px]:py-0 min-[600px]:first:pl-0 min-[600px]:last:pr-0"
                >
                  ...
                  <dd className="text-3xl font-bold text-slate-900 min-[960px]:text-4xl">
        ...
        <article className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm leading-7 text-slate-600 min-[960px]:text-base">
