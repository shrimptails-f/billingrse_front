...
export const TextField = forwardRef<HTMLInputElement, Props>((props, ref) => {
  ...
  const baseClass =
    'w-full rounded-xl border bg-white px-4 py-3 text-slate-900 shadow-inner transition focus:outline-none focus:ring-2';
  ...
  const composedClass = [baseClass, error ? errorStateClass : normalStateClass, className]
    .filter(Boolean)
    .join(' ');
